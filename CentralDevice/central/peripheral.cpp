...
BLECharacteristic MessageCharacteristic("19B10001-E8F2-537E-4F6C-D104768A1214", BLERead | BLENotify | BLEWrite,
     sizeof(Message), true);
...
void setupPeripheral() {
  ...
  // start advertising
  BLE.advertise();
  Serial.println("BLE Message Peripheral, waiting for connections....");
}
